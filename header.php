...
<head><title><?=isset($title) ? $title : 'Whit Davis PTO Website';?></title>
<meta content="text/html; charset=iso-8859-2" http-equiv=Content-Type>
<link rel=stylesheet href="/whitdavispto.css" />
</head>
<body>
...
<div id="container">
    ...
    <div id="header">
        <a href="/"><img src="/img/Whit-Name-Web-Header.gif" width="332" height="126" style="float:left;"></a>
        <img src="/img/paws.gif" width="244" height="126" style="float:right;">
    </div>
